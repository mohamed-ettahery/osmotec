            ...
            <div class="row">
                <div class="col-lg-8 md-mb-50">
                    <div class="services-img mb-35">
                        <img src="{{ asset('assets/images/all/IMG-20230321-WA0034.webp') }}" alt="OSMOTEC BWRO LS">
                    </div>
                    <div class="services-title pb-24">
                        <h2 class="title">OSMOTEC BWRO LS </h2>
                    </div>
                    <p class="desc-part pb-24">
                        Unité de déminéralisation OSMOTEC BWRO LS, pour l'alimentation en eau potable l'irrigation et les
                        industries, à travers la déminéralisation par membranes d'Osmose Inverse
                    </p>
                    ...
                    <ul class="check-lists3">
                        <li>Traitement par membranes d'Osmose Inverse pour eau saumâtre, pour l'élimination de sels dissous:
                            sels minéraux, métaux lourds, matière organique dissoute, pesticides, etc..</li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="{{ asset('assets/images/all/industry-generic-2-6.webp') }}" alt="OSMOTEC TRUCK | OSMOTEC BWRO LS">
                    </div>
