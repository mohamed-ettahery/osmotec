            ...
            <div class="row">
                <div class="col-lg-8 md-mb-50">
                    <div class="services-img mb-35">
                        <img src="{{ asset('assets/images/all/IMG-20230321-WA0047.webp') }}" alt="OSMOTEC SWRO">
                    </div>
                    <div class="services-title pb-24">
                        <h2 class="title">OSMOTEC SWRO</h2>
                    </div>
                    <p class="desc-part pb-24">
                        Unité de dessalement OSMOTEC SWRO, pour l'alimentation en eau potable ,l'irrigation et les
                        industries, à travers le dessalement par membranes d'Osmose Inverse
                    </p>
                    ...
                    <ul class="check-lists3">
                        <li>Traitement par membranes d'Osmose Inverse pour eau de mer, pour l'élimination de sels
                            dissous: sels minéraux, métaux lourds, matière organique dissoute, pesticides, etc.</li>
                        <li>Espace minimum d'implantation et configuration modulaire extensible pour les besoins
                            futurs accrus.</li>
                        <li>Système totalement automatisé, pour l'opération autonome de l'unité sans besoin de
                            personnel qualifié.</li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="{{ asset('assets/images/all/industry-generic-2-6.webp') }}" alt="OSMOTEC TRUCK | OSMOTEC SWRO">
                    </div>
                    <div class="col-md-6 pt-50">
                        <ul class="check-lists3">
                            <li>Neutralisation et conditionnement de l'eau traitée dans le cas de l'eau industriel.</li>
                            <li>Alimentation éléctrique en energie solaire dans les zones non reliées au réseau
                                électrique.</li>
                            <li>Télégestion et commande à distance .</li>
                            <li>Pellentesque ultricies nubh.</li>
                        </ul>
                    </div>
                </div>
            </div>
