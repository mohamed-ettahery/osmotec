            ...
            <div class="row">
                <div class="col-lg-8 md-mb-50">
                    <div class="services-img mb-35">
                        <img src="{{ asset('assets/images/all/IMG-20230321-WA0018.webp') }}" alt="OSMOTEC BWRO MS">
                    </div>
                    <div class="services-title pb-24">
                        <h2 class="title">OSMOTEC BWRO MS</h2>
                    </div>
                    <p class="desc-part pb-24">
                        Unité de potabilisation OSMOTEC BWRO MS, pour l'alimentation en eau potable l'irrigation et
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="{{ asset('assets/images/all/industry-generic-2-6.webp') }}"
                            alt="OSMOTEC TRUCK | OSMOTEC BWRO MS">
                    </div>
